...
public class BabyDiaryServiceImpl implements BabyDiaryService{
    ...
    public void modify(BabyDiaryDTO babyDiaryDTO, String email) {
        ...
        if ("".equals(newPhotoFileName)) {
            finalPhotoFileName = null;
        } else if (newPhotoFileName != null) {
            finalPhotoFileName = newPhotoFileName;
        } else {
            finalPhotoFileName = oldPhotoFileName;
        }

        if (oldPhotoFileName != null && !oldPhotoFileName.equals(finalPhotoFileName)) {
            customFileUtil.deleteFiles(List.of(oldPhotoFileName));
        }

        babyDiary.changeContent(babyDiaryDTO.getContent());
        babyDiary.changePhotoFileName(finalPhotoFileName);
